  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      if (parsedUser && typeof parsedUser.role === 'string' && 
        ...
        // 🚀 Preload estratégico após restaurar usuário
        preloadCriticalComponents(parsedUser.role);
      }
    }
  }, []);
  ...
  const login = async (email: string, password: string): Promise<User> => {
    try {
      ...
      if (typeof loggedUser.role === 'string' && 
        ...
        // 🚀 Preload estratégico baseado no papel do usuário
        preloadCriticalComponents(typedUser.role);
